...
class WarningControllerYamlTest extends AbstractIntegrationTest {
    ...
    void login() throws JsonProcessingException {
        ...
        tokenDTO = given().config(RestAssuredConfig.config().encoderConfig(
    ...
    void create() {
        ...
        warningDTO = given().config(RestAssuredConfig.config().encoderConfig(
                        EncoderConfig.encoderConfig()
                                .encodeContentTypeAs(MediaType.APPLICATION_YAML_VALUE, ContentType.TEXT)))
                .spec(specification)
                .contentType(MediaType.APPLICATION_YAML_VALUE)
                .accept(MediaType.APPLICATION_YAML_VALUE)
                .body(warningDTO, objectMapper)
                .when()
                .post()
                .then()
                .statusCode(200)
                .extract()
                .body()
                .as(WarningDTO.class, objectMapper);
    ...
    @Order(3)
    void findById() {
        WarningDTO found = given().config(RestAssuredConfig.config().encoderConfig(
                        EncoderConfig.encoderConfig()
                                .encodeContentTypeAs(MediaType.APPLICATION_YAML_VALUE, ContentType.TEXT)))
                .spec(specification)
                .accept(MediaType.APPLICATION_YAML_VALUE)
    ...
    @Order(4)
    void findAll() {
        var wrapper = given().config(RestAssuredConfig.config().encoderConfig(
                        EncoderConfig.encoderConfig()
                                .encodeContentTypeAs(MediaType.APPLICATION_YAML_VALUE, ContentType.TEXT)))
                .spec(specification)
                .accept(MediaType.APPLICATION_YAML_VALUE)
                ...
                .extract()
                .body()
                .as(PagedModelWarning.class, objectMapper);

        List<WarningDTO> warnings = wrapper.getContent();
