...
class LoanControllerXmlTest extends AbstractIntegrationTest {
    ...
    void findByStudent() throws JsonProcessingException {
        ...
        PagedModelLoan wrapper = objectMapper.readValue(content, PagedModelLoan.class);

        assertNotNull(wrapper);
        assertNotNull(wrapper.getContent());
        assertTrue(wrapper.getContent().size() >= 1);
    }
    ...
    void findOverdue() throws JsonProcessingException {
        ...
        wrapper.getContent().forEach(loanDTO ->
